...
#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "5560200410 6754286457"))
...
SHORTLINK_API = os.environ.get("SHORTLINK_API", "ebbc0543f2cbc6ec143e32ba2c51c9f149dd71e0")
VERIFY_EXPIRE = int(os.environ.get('VERIFY_EXPIRE', 86400)) # Add time in seconds
IS_VERIFY = os.environ.get("IS_VERIFY", "True")
TUT_VID = os.environ.get("TUT_VID", "https://t.me/howto_open_tatelikns") # shareus ka tut_vid he 

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002098980021"))
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "5560200410 7548122975 6754286457").split()):
        ADMINS.append(int(x))
except ValueError:
